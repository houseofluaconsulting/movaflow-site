...
export const _veteranWebsiteAgedPricingPlans = [
  {
    ...
    lists: ['Disconnected number replacement', 'Exclusive Leads', 'Live lead transfer directly to your CRM', 'Includes call scripts, text templates, and weekly team Q&A sessions'],
    labelAction: 'Purchase',
    priceId: 'price_1SIDRsQEFFyZAREYnhn7CObj',
  },
  {
    credit: '30/35',
    opportunity: 'Mixed',
    ...
    lists: ['Disconnected number replacement', 'Exclusive Leads', 'Live lead transfer directly to your CRM', 'Includes call scripts, text templates, and weekly team Q&A sessions'],
    labelAction: 'Purchase',
    priceId: 'price_1SO0e0GHAeFkU5hvRz167Rsy',
  },
  {
    credit: '40/50',
    opportunity: 'Mixed',
    ...
    lists: ['Disconnected number replacement', 'Exclusive Leads', 'Live lead transfer directly to your CRM', 'Includes call scripts, text templates, and weekly team Q&A sessions'],
    labelAction: 'Purchase',
    priceId: 'price_1SO0edGHAeFkU5hve0Qdxd7s',
  },
  {
    credit: '50/60',
    opportunity: 'Mixed',
    ...
    lists: ['Disconnected number replacement', 'Exclusive Leads', 'Live lead transfer directly to your CRM', 'Includes call scripts, text templates, and weekly team Q&A sessions'],
    labelAction: 'Purchase',
    priceId: 'price_1SO0fdGHAeFkU5hvjJSv79fN',
  },
];
