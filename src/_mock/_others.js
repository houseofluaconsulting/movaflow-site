...
export const _veteranWebsitePricingPlans = [
  ...
  },
  {
    ...
    lists: ['Disconnected number replacement', 'Exclusive Leads', 'Live lead transfer directly to your CRM', 'Includes call scripts, text templates, and weekly team Q&A sessions'],
    labelAction: 'Purchase',
    priceId: 'price_1SPYKuGHAeFkU5hvg2mQqJGG',
  },
  {
    credit: '40',
    opportunity: 'Fresh',
...
export const _veteranWebsiteAgedPricingPlans = [
  {
    ...
    opportunity: 'Mixed',
    type: 'Veteran Website Leads',
    description: '20 Fresh & 25 Aged',
    freshPrice: 39,
    agedPrice: 8,
    amount: '$980.00',
    lists: ['Disconnected number replacement', 'Exclusive Leads', 'Live lead transfer directly to your CRM', 'Includes call scripts, text templates, and weekly team Q&A sessions'],
    labelAction: 'Purchase',
    priceId: 'price_1SPYUeGHAeFkU5hv5YzEeFnX',
  },
  {
    credit: '30/35',
    opportunity: 'Mixed',
    type: 'Veteran Website Leads',
    description: '30 Fresh & 35 Aged',
    freshPrice: 37,
    agedPrice: 8,
    amount: '$1390.00',
    lists: ['Disconnected number replacement', 'Exclusive Leads', 'Live lead transfer directly to your CRM', 'Includes call scripts, text templates, and weekly team Q&A sessions'],
    labelAction: 'Purchase',
    priceId: 'price_1SPYXQGHAeFkU5hvp2tNcy1I',
  },
  {
    credit: '40/50',
    opportunity: 'Mixed',
    ...
    lists: ['Disconnected number replacement', 'Exclusive Leads', 'Live lead transfer directly to your CRM', 'Includes call scripts, text templates, and weekly team Q&A sessions'],
    labelAction: 'Purchase',
    priceId: 'price_1SPYZqGHAeFkU5hvLLlNwmXF',
  },
  {
    credit: '50/60',
    opportunity: 'Mixed',
...
export const _legacyWebsitePricingPlans = [
  ...
  },
  {
    ...
    lists: ['Disconnected number replacement', 'Exclusive Leads', 'Live lead transfer directly to your CRM', 'Includes call scripts, text templates, and weekly team Q&A sessions'],
    labelAction: 'Purchase',
    priceId: 'price_1SAc0NGHAeFkU5hvHHvCCa4L',
  },
  {
    credit: '60',
    opportunity: 'Fresh',
